...
module.exports = {
  ...
  /////////////////////////////////
    ...
    async beforeCreate(event) {
      ...
      helper.createSlugs(event.params.data, locale, 'name');

      // TODO_FUTURE
      // strapi.services.article.validate.article_group(data);
    },
    ...
    async afterCreate(event) {
      ...
      await strapi.service(UID.autocomplete).indexOne(indexList.find(it => it.name === 'partner'), row.id);
    },
